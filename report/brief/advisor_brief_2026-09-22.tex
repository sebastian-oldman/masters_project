...
The same trajectory that the Oregon report draws is now in the report as Figure~5.8 (Figure~\ref{f:share}): with the adopted CEC Planning forecast, data centers go from 3 to 4 percent of California's electricity today to 6.6 percent in 2030 and about 10 percent in 2035 to 2040; under the CEC's Local Reliability scenario 11.3 percent in 2030 and 12.5 to 13.5 percent after; if every requested megawatt ran flat by 2030 the share would be 40 percent, or 29 percent at the CEC's utilization factor.\src{https://efiling.energy.ca.gov/GetDocument.aspx?tn=268824}{CEC, CED 2025 Planning forecast, Form 1.1c data center allocations, TN 268824; statewide energy to serve load from TN 268727 (Planning) and TN 268725 (Local Reliability)} Oregon's 23 percent today is above California's 2040 Local Reliability share; California's upper bound is above Oregon's 2030 projection.

\begin{figure}[H]
\centering\includegraphics[width=\textwidth]{fig4_08_dc_share_of_electricity}
\caption{Report Figure 5.8: data centers as a share of California's electricity, history, the CED 2025 scenarios and the 2030 bounds (sources: \href{https://restservice.epri.com/publicdownload/000000003002028905/0/Product}{EPRI 2024}; \href{https://www.energy.ca.gov/sites/default/files/2026-04/Data_Center_Methodology_Memo_ada.pdf}{CEC methodology memo}; \href{https://efiling.energy.ca.gov/GetDocument.aspx?tn=268824}{CED 2025 data center allocations, TN 268824}; \href{https://efiling.energy.ca.gov/GetDocument.aspx?tn=268727}{CED 2025 Planning forms, TN 268727}).}
\label{f:share}
\end{figure}
