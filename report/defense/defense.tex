...
\begin{frame}{Chapter 1: the same five charts as the Finnish study, for CAISO}
\begin{columns}[T]
\column{0.5\textwidth}
\includegraphics[width=\textwidth]{fig1_09_consumption_2026}
\column{0.5\textwidth}
\includegraphics[width=\textwidth]{fig1_12_imports_exports_monthly}
\end{columns}
\begin{itemize}\small
\item January to September 2026: demand 18,748 to 49,959~MW, mean 27,202~MW; generation inside CAISO covered a mean 19,329~MW and net imports 4,405~MW.
\item 2025: 42.0~TWh of gross imports against 6.0~TWh of exports; wind ran at 26 percent and solar at 25 percent of nameplate in 2026; the consumption CO$_2$ factor averaged 163~g/kWh against Finland's 29 to 31.
\end{itemize}
\end{frame}
...
\begin{frame}{Data centers as a share of California's electricity}
\includegraphics[width=\textwidth,height=0.66\textheight,keepaspectratio]{fig4_08_dc_share_of_electricity}
\begin{itemize}\small
\item 3.9 percent of retail sales in 2023; 6.6 percent in 2030 and 10.1 percent in 2040 under the adopted Planning forecast; 11.3 and 12.5 percent under Local Reliability; 40 percent if every request ran flat by 2030 (29 percent at the CEC's utilization). Oregon: 23 percent today, 31 to 32 percent by 2030.
\end{itemize}
\end{frame}
