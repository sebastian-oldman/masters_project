#!/usr/bin/env python
"""Write report/brief/advisor_brief_<date>.tex: the progress memo for the advisor, with every referenced report figure embedded
(cross-linked with hyperref) and a clickable source link on every claim, the URLs taken from the manifest by source id."""
...
from src.paths import RAW, ROOT  # noqa: E402
...
The two are consistent. The Oregon figure comes from the ECOnorthwest and University of Virginia report of September 2026, as reported by Oregon Public Broadcasting: 111 operating data centers used about 23 percent of Oregon's retail electricity sales in 2025, with nearly 25~TWh expected by 2030.\src{@@opb_oregon_data_centers_2026_09@@}{OPB, ``Oregon data centers by the numbers'', September 17 2026, on the ECOnorthwest and University of Virginia report} Oregon's retail sales were 60~TWh in 2024 against California's 246~TWh, so 23 percent of Oregon is about 14~TWh, the same order as California's 7 to 9~TWh, which are 3 to 4 percent of a market four times larger.\src{@@eia861_2024@@}{EIA-861 2024, Sales to Ultimate Customers (parts A, C and D), computed for both states with the report's method} The Oregon-like number exists in California at the city scale: Silicon Valley Power, Santa Clara's municipal utility, reports data centers at 53 to 60 percent of its 4.5~TWh of sales.\src{@@svp_assembly_hearing_2026_01_28@@}{Silicon Valley Power, presentation to the Assembly oversight hearing, January 28 2026; fact sheets 2017 to 2023} The report presents the state figure as a range of four estimates because there is no metered total (Figure~\ref{f:dc}).

\begin{figure}[H]
\centering\includegraphics[width=\textwidth]{fig1_08_existing_dc_load_estimates}
\caption{Report Figure 2.8: existing data center electricity use in California, four estimates (sources: \href{@@epri_powering_intelligence_2024@@}{EPRI, Powering Intelligence 2024, state table}; \href{@@cec_dc_methodology_memo_2026@@}{CEC methodology memo}; \href{@@svp_assembly_hearing_2026_01_28@@}{SVP}).}
\label{f:dc}
\end{figure}

The same trajectory that the Oregon report draws is now in the report as Figure~5.8 (Figure~\ref{f:share}): with the adopted CEC Planning forecast, data centers go from 3 to 4 percent of California's electricity today to 6.6 percent in 2030 and about 10 percent in 2035 to 2040; under the CEC's Local Reliability scenario 11.3 percent in 2030 and 12.5 to 13.5 percent after; if every requested megawatt ran flat by 2030 the share would be 40 percent, or 29 percent at the CEC's utilization factor.\src{@@cec_tn268824@@}{CEC, CED 2025 Planning forecast, Form 1.1c data center allocations, TN 268824; statewide energy to serve load from TN 268727 (Planning) and TN 268725 (Local Reliability)} Oregon's 23 percent today is above California's 2040 Local Reliability share; California's upper bound is above Oregon's 2030 projection.

\begin{figure}[H]
\centering\includegraphics[width=\textwidth]{fig4_08_dc_share_of_electricity}
\caption{Report Figure 5.8: data centers as a share of California's electricity, history, the CED 2025 scenarios and the 2030 bounds (sources: \href{@@epri_powering_intelligence_2024@@}{EPRI 2024}; \href{@@cec_dc_methodology_memo_2026@@}{CEC methodology memo}; \href{@@cec_tn268824@@}{CED 2025 data center allocations, TN 268824}; \href{@@cec_tn268727@@}{CED 2025 Planning forms, TN 268727}).}
\label{f:share}
\end{figure}

\paragraph{No uptick in California after 2022?}
Not in the physical indicators, and that is the finding rather than a puzzle. The national Census series is construction spending on data centers (Figure~\ref{f:census}); it rose from USD 1.6 billion a year in January 2014 to 75.2 billion in July 2026, and the break located by the data is March 2022, after which the series grew 61 percent a year until mid-2024 and 36 percent since.\src{@@census_c30_privsatime@@}{Census Bureau, Value of Construction Put in Place, private, seasonally adjusted (privsatime.xlsx), data center line} California's own indicators did not follow (Figure~\ref{f:proxies}). Employment in computing infrastructure, data processing and hosting (QCEW industry 518210) grew 12 percent a year to 74,000 jobs by the end of 2022, stepped to 84,000 in the first quarter of 2023 and has been flat since (84,000 in the first quarter of 2026);\src{@@qcew_518210_2026q1@@}{BLS Quarterly Census of Employment and Wages, NAICS 518210, California, quarterly files 2014 to 2026 Q1} Silicon Valley colocation capacity under construction has stayed between 125 and 168~MW since 2023;\src{@@cbre_sv@@}{CBRE North America Data Center Trends, Silicon Valley market chapters (Infogram tables), H2 2025 and H1 2026} and Epoch AI's satellite-tracked hub lists 75 large United States AI sites, led by Texas, Virginia, Ohio and Iowa, with none in California.\src{@@epoch_data_centers@@}{Epoch AI, Frontier Data Centers Hub, data\_centers.csv (snapshot of September 22 2026)} What rose in California is requests to connect: the CEC's like-for-like count of signed agreements plus applications at PG\&E and SCE went from 6,771~MW in December 2024 to 11,219~MW in December 2025, and the full three-tier count reached 20,677~MW in the state (Figure~\ref{f:tiers}).\src{@@cec_dc_methodology_memo_2026@@}{CEC, Data Center Methodology Memo, April 2026, Table 1; preliminary forecast deck of October 30 2025, slides 6 and 7} The uptick is on paper; the physical build is going where power and land are available.
...
SCE is the only utility that publishes its request list project by project, twice so far, in August 2025 and January 2026.\src{@@cec_tn268459@@}{SCE, IEPR 2025 Data Center Database (public), January 29 2026, TN 268459; the August 29 2025 edition is TN 266008} Between the two snapshots the active requests fell from 6,201 to 5,162~MW while the cumulative cancelled amount rose from 709 to 3,137~MW: 2.4~GW of requests were cancelled in five months even as new ones arrived. The same list shows advancement, since the inquiry tier fell from 5,934 to 1,773~MW while the application tier grew from 216 to 3,313~MW. So the pipeline churns in both directions, and about 38 percent of everything SCE has ever recorded is now cancelled. That churn is the empirical reason to discount requests rather than count them (Figure~\ref{f:tiers}; report Table 3.9).

\begin{figure}[H]
\centering\includegraphics[width=\textwidth]{fig2_04_tier_vintages}
\caption{Report Figure 3.4: energization requests by vintage and tier against the grid, with Nevada separated and SCE's cancellations shown (sources: \href{@@cec_assembly_hearing_2026_01_28@@}{CEC presentation to the Assembly oversight hearing, January 28 2026}; \href{@@caiso_key_statistics_2026_08@@}{CAISO Key Statistics, August 2026}).}
\label{f:tiers}
\end{figure}

\paragraph{Forty percent of peak; what share of the total?}
Because a data center runs flat, the energy comparison is the stronger one and the report carries both (Table 3.10). If all 20,677~MW ran flat at full capacity they would draw 181~TWh a year, 81 to 84 percent of CAISO's 216 to 224~TWh of annual demand and 69 percent of the state's 263~TWh;\src{@@cec_tn268727@@}{CEC, CED 2025 Planning forecast, Form 1.5a (statewide energy to serve load 2025 and 2030)} at the CEC's 67 percent utilization and an 88 percent load factor, 107~TWh, three times the state's forecast energy growth to 2030. The signed tier alone, 5,086~MW, would draw 45~TWh flat, a fifth of CAISO's demand. The CEC's own probability-weighted central case is 12~TWh in 2030, 4 percent of the 298~TWh the state forecasts for that year.\src{@@cec_tn268824@@}{CEC, CED 2025 Planning forecast, Form 1.1c data center allocations, TN 268824}

\paragraph{California-only headline, or other states?}
The headline stays California-only (20,677~MW, with the 2,600~MW that Valley Electric reported for Nevada as a memo line and the CEC's 23,277~MW total beside it). No consistent 50-state series exists, which is itself a finding of the regime comparison. Two other regions enter as data (Figure~\ref{f:ercot}): ERCOT publishes its queue monthly by phase, 63~GW of requests in December 2024 and 467~GW by July 2026 against 9.5~GW approved to energize and about 4~GW observed operating,\src{@@ercot_ops_overview_2026_07@@}{ERCOT, Monthly Operational Overview, July 2026, slides 9 and 10; ERCOT Monthly, July 2025 (63 GW in December 2024)} and PJM publishes an explicit firm and non-firm rule with 33.7~GW of large-load adjustments in its 2030 forecast.\src{@@pjm_2026_load_report_tables@@}{PJM, 2026 Load Forecast Report tables, Table B-9; Load Adjustment Requests Summary, November 24 2025} Oregon can be added as a comparison row from the ECOnorthwest report if you would like it.
...
\begin{itemize}
\item The CAISO record peak of 52,061~MW was set on September 6, 2022, not in October 2023.\src{@@caiso_key_statistics_2026_08@@}{CAISO, Key Statistics, August 2026}
...
\item Midday prices in 2025 averaged USD 13 per MWh at the SCE point and 24 to 26 at the PG\&E point (11:00 to 14:00); evening prices (18:00 to 20:00) averaged 49 to 56. The ranges I quoted mixed years and nodes.\src{@@caiso_dam_lmp_monthly_dlap@@}{CAISO OASIS, day-ahead locational marginal prices, PRC\_LMP DAM, default load aggregation points}
\end{itemize}
...
def main() -> int:
    ...
    m = pd.read_csv(RAW / "manifest.csv").sort_values("access_date").groupby("source_id").tail(1).set_index("source_id")
    url = lambda i: str(m.loc[i, "url"])  # noqa: E731
    U = {i: url(i) for i in ["cec_tn268727", "eia930_balance_2025_jul_dec", "caiso_managing_evolving_grid_page", "opb_oregon_data_centers_2026_09", "eia861_2024", "svp_assembly_hearing_2026_01_28",
                             "epri_powering_intelligence_2024", "census_c30_privsatime", "qcew_518210_2026q1", "epoch_data_centers", "cec_dc_methodology_memo_2026", "cec_tn268459",
                             "cec_assembly_hearing_2026_01_28", "cec_tn268824", "ercot_ops_overview_2026_07", "pjm_2026_load_report_tables", "caiso_key_statistics_2026_08", "caiso_dam_lmp_monthly_dlap"]}
    U["caiso_outlook_co2"] = url("caiso_outlook_co2").replace("YYYYMMDD", "20250701")
    cbre = [i for i in m.index if i.startswith("cbre_h2_2025_silicon_valley")] or [i for i in m.index if i.startswith("cbre_") and "silicon" in i]
    U["cbre_sv"] = url(cbre[0]) if cbre else url("cbre_h2_2025_overview_infogram_fig6")
    tex = TEMPLATE
    for k, v in U.items():
        tex = tex.replace(f"@@{k}@@", v.replace("%", "\\%").replace("#", "\\#"))
    assert "@@" not in tex, "unresolved placeholder"
    out = ROOT / "report" / "brief" / f"advisor_brief_{a.date}.tex"; out.write_text(tex); print("wrote", out, "with", len(U), "linked sources")
    return 0
