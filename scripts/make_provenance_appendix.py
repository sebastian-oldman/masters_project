...
ROWS = {
    ...
    4: [
        ("fig4_01", "Data center demand in 2030 under each counting rule; statewide peak by IEPR case against ELCC supply", ["ch4_demand_cases_2030.csv", "ch4_ca_tiers.csv", "ch4_iepr_growth_summary.csv", "ch4_ercot_chain.csv", "ch3_cases_2030_summary.json"], ["cec_assembly_hearing_2026_01_28", "cec_dc_methodology_memo_2026", "cec_tn268722 .. 268727 (CED 2025 forms)", "cec_tn268124", "cec_tn268824", "ERCOT decks and monthlies (see fig4_05)", "pjm_lar_summary_2025_11_24"], "ch4_gap.ca_tiers, cec_parameters, ced2025_scenarios, iepr_growth_cases, ercot_chain, demand_cases_2030; run_chapter4 steps 1-3"),
